...
import { VsatIntakeProvider } from "./contexts/VsatIntakeContext";
...
export default function ClientRootLayout({ children, vsatIntake }) {
  useEffect(() => {
    storeUtmParams();
    sendUtmToAnalytics();
  }, []);
  ...
  return (
    <Provider store={store}>
      <VsatIntakeProvider value={vsatIntake}>
